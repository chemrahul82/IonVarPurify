...
$annovar_dir/table_annovar.pl \
	...
	$somatic_input \
	$annovar_dir/humandb/ \
	--outfile annovar_variants_table \
	--buildver hg19 \
...
$annovar_dir/coding_change.pl annovar_variants_table.refGene.exonic_variant_function \
	$annovar_dir/humandb/hg19_refGene.txt \
	$annovar_dir/humandb/hg19_refGeneMrna.fa > annovar_variants_table_mnp.log


mkdir -p annovar_tmp
mv annovar_variants_table.hg19_multianno.txt annovar_variants_annotation_table.txt
mv annovar_variants_table.* annovar_tmp/
rm -r annovar_tmp
