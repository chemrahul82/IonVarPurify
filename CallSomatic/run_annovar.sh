...
$annovar_dir/coding_change.pl annovar_somatic_table.refGene.exonic_variant_function \
	$annovar_dir/humandb/hg19_refGene.txt \
	$annovar_dir/humandb/hg19_refGeneMrna.fa > annovar_somatic_table_mnp.log


mkdir -p annovar_tmp
mv annovar_somatic_table.hg19_multianno.txt annovar_somatic_annotation_table.txt
mv annovar_somatic_table.* annovar_tmp/
rm -r annovar_tmp
